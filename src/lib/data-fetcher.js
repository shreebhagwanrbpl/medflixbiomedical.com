...
export async function fetchHomeData() {
    return fetchDocCached("websites/medflixbiomedicalcom/pages/home");
}

export async function fetchContactData() {
    return fetchDocCached("websites/medflixbiomedicalcom/pages/contact");
}

export async function fetchServicesData() {
    return fetchDocCached("websites/medflixbiomedicalcom/pages/services");
}

export async function fetchDistrictData(district) {
    if (!district) return null;
    return fetchDocCached(`websites/medflixbiomedicalcom/districts/${district}`);
}
...
export function subscribeToCatalog(onUpdate) {
    ...
    try {
        const legacyUnsub = onSnapshot(
            doc(db, "websites", "medflixbiomedicalcom", "pages", "products"),
            (docSnap) => {
                if (docSnap.exists()) {
