...
export default function AboutPage() {
  ...
  return (
    <div className="bg-[#f6fbfa]/60 text-[#133835]">
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-6 relative">
              <div className="relative overflow-hidden rounded-[36px] border border-[#cdeae5] bg-gradient-to-br from-[#ebf7f5] via-white to-[#d8f0ec] p-8 shadow-xl shadow-[#0b6e69]/10">
                <Image
                  src={DDS}
              ...
              {/* Floating Stat Badge */}
              <div className="absolute -bottom-6 -right-6 hidden sm:flex items-center gap-4 rounded-3xl border border-[#cdeae5] bg-white p-6 shadow-2xl">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#0b6e69] text-white font-black text-2xl">
                  10+
                </div>
                <div>
                  <h4 className="text-lg font-bold text-[#133835]">Years Experience</h4>
                  <p className="text-xs text-[#496a66]">Trusted Biomedical Partner</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-6">
              <SectionTitle
                ...
                description="Raj Biosis Private Limited (Raj Biosis) was founded with a singular mission: to provide Indian hospitals and laboratories with reliable, world-class diagnostic technology backed by instant field service."
              />

              <div className="mt-8 space-y-4 text-base sm:text-lg leading-relaxed text-[#496a66]">
                <p>
              ...
              <div className="mt-8 grid sm:grid-cols-2 gap-4">
                <div className="flex items-center gap-3 rounded-2xl border border-[#cdeae5] bg-white p-4 shadow-sm">
                  <CheckCircle2 size={20} className="text-[#0b6e69] shrink-0" />
                  <span className="text-sm font-bold text-[#133835]">NABL Traceable QC</span>
                </div>
                <div className="flex items-center gap-3 rounded-2xl border border-[#cdeae5] bg-white p-4 shadow-sm">
                  <CheckCircle2 size={20} className="text-[#0b6e69] shrink-0" />
                  <span className="text-sm font-bold text-[#133835]">2-Hour SLA Maintenance</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding bg-white border-y border-[#cdeae5]/60">
        <div className="container-custom">
          <SectionTitle
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2">
            <div className="rounded-3xl border border-[#cdeae5] bg-gradient-to-br from-[#e6f4f2] to-white p-8 sm:p-10 shadow-md">
              <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#0b6e69] text-white shadow-md">
                <Target size={28} />
              </div>

              <h3 className="text-2xl font-bold text-[#133835]">Our Mission</h3>
              ...
              <ul className="mt-6 space-y-2.5 text-sm text-[#496a66]">
                <li className="flex items-center gap-2">
                  <CheckCircle2 size={16} className="text-[#0b6e69]" />
            ...
            <div className="rounded-3xl border border-[#cdeae5] bg-gradient-to-br from-[#ebf7f5] to-white p-8 sm:p-10 shadow-md">
              <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#0e938b] text-white shadow-md">
                <Eye size={28} />
              </div>

              <h3 className="text-2xl font-bold text-[#133835]">Our Vision</h3>
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {values.map((val, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="group rounded-3xl border border-[#cdeae5] bg-white p-8 shadow-md transition-all duration-300 hover:-translate-y-2 hover:border-[#0b6e69]/40 hover:shadow-xl"
                >
                  <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#e6f4f2] text-[#0b6e69] transition-colors group-hover:bg-[#0b6e69] group-hover:text-white">
                    <Icon size={28} />
                  </div>

                  <h4 className="text-xl font-bold text-[#133835] group-hover:text-[#0b6e69] transition-colors">
                    {val.title}
                  </h4>

                  <p className="mt-3 text-sm leading-relaxed text-[#496a66]">
                    {val.desc}
                  </p>
                </div>
              );
        ...
        <div className="container-custom">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {milestones.map((m, idx) => (
              <div
                key={idx}
                className="relative overflow-hidden rounded-3xl border border-[#cdeae5] bg-[#e6f4f2] p-8 shadow-sm transition-all hover:border-[#0b6e69]/50 hover:shadow-md"
              >
                <span className="text-4xl font-black text-[#0b6e69]">
                  {m.year}
                </span>
                <h4 className="mt-4 text-xl font-bold text-[#133835]">{m.title}</h4>
                <p className="mt-2 text-xs sm:text-sm text-[#496a66] leading-relaxed">
                  {m.desc}
                </p>
              </div>
            ))}
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-[#072f2c] via-[#0b4d48] to-[#072f2c] py-16 text-white text-center">
        <div className="container-custom max-w-4xl">
          <h2 className="text-3xl sm:text-4xl font-black text-white">
            Ready to Upgrade Your Laboratory Technology?
          </h2>
          <p className="mt-4 text-base sm:text-lg text-[#cdeae5]/90">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-2xl bg-[#0b6e69] px-8 py-4 text-base font-bold text-white shadow-lg transition-all hover:bg-[#074e49]"
            >
            ...
            <Link
              href={makeLink("/items")}
              className="inline-flex items-center gap-2 rounded-2xl border border-[#cdeae5]/40 bg-white/10 px-8 py-4 text-base font-bold text-white shadow-sm transition-all hover:bg-white/20"
            >
