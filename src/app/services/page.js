  ...
  return (
    <div className="bg-[#f6fbfa]/60 text-[#133835]">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {workflowSteps.map((step, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group relative flex flex-col justify-between overflow-hidden rounded-3xl border border-[#cdeae5] bg-[#e6f4f2] p-8 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:border-[#0b6e69] hover:shadow-xl"
                >
                  <div>
                    <div className="flex items-center justify-between">
                      <span className="text-4xl font-black text-[#0b6e69]/40 group-hover:text-[#0b6e69] transition-colors">
                        {step.step}
                      </span>
                      <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-[#0b6e69] shadow-sm">
                        <Icon size={24} />
                      </div>
                    </div>

                    <h3 className="mt-6 text-xl font-bold text-[#133835] group-hover:text-[#0b6e69] transition-colors">
                      {step.title}
                    </h3>
                  ...
                  <div className="mt-6 pt-4 border-t border-[#cdeae5]/40">
                    <span className="text-xs font-bold text-[#0b6e69]">Phase {index + 1} Milestone</span>
                  </div>
                </div>
              );
            })}
      ...
      <section className="section-padding bg-gradient-to-b from-[#ebf7f5] via-white to-[#f6fbfa]">
        <div className="container-custom">
          <div className="rounded-3xl border border-[#cdeae5] bg-gradient-to-r from-[#072f2c] via-[#0b4d48] to-[#072f2c] p-8 sm:p-12 text-white shadow-xl">
            <div className="grid lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-8">
                <span className="inline-flex items-center gap-2 rounded-full bg-[#0b6e69] px-4 py-1.5 text-xs font-bold text-white uppercase tracking-wider">
                ...
                <p className="mt-3 text-base text-[#cdeae5] leading-relaxed">
              ...
              <div className="lg:col-span-4 flex flex-col items-center justify-center text-center border-t lg:border-t-0 lg:border-l border-[#cdeae5]/20 pt-6 lg:pt-0 lg:pl-8">
                <p className="text-xs font-bold uppercase tracking-wider text-[#cdeae5]">Emergency Dispatch</p>
                {emergencyPhone ? (
                  <a
                    href={`tel:${emergencyPhone.replace(/\s+/g, "")}`}
                    className="mt-2 text-2xl font-black text-white hover:text-[#14b8a6] transition-colors inline-block"
                  >
                    {emergencyPhone}
                  </a>
                ) : (
                  <p className="mt-2 text-sm text-[#cdeae5]">24/7 Field Dispatch Active</p>
                )}
                <Link
                  href={makeLink("/contact")}
                  className="mt-5 w-full rounded-2xl bg-[#0b6e69] py-3.5 text-center text-sm font-bold text-white shadow-lg transition-all hover:bg-[#074e49]"
                >
