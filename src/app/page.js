...
export default function Home({ city }) {
  ...
  return (
    <div className="bg-[#f6fbfa]/60 text-[#133835]">
      ...
      {/* ================= STATS TICKER ================= */}
      <section className="bg-gradient-to-r from-[#072f2c] via-[#0b4d48] to-[#072f2c] py-10 text-white shadow-inner">
            ...
            {stats.map((item, idx) => {
              ...
              return (
                <div key={idx} className="flex items-center gap-4">
                  <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[#0b6e69]/30 text-[#a5d8d0] border border-[#0b6e69]/50">
                    <Icon size={26} />
                  </div>
                  <div>
                    ...
                    <p className="text-xs sm:text-sm font-bold text-[#a5d8d0]">{item.title}</p>
                    <p className="text-[11px] text-[#cdeae5]/80 hidden sm:block">{item.desc}</p>
                  </div>
                </div>
              );
            })}
      ...
      <section className="section-padding bg-gradient-to-b from-white via-[#f6fbfa] to-[#ebf7f5]">
        <div className="container-custom">
          <SectionTitle
            ...
            title="Precision Without the Noise"
            description="Precision diagnostics, calmly designed for modern laboratories."
            center
          />
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {pillars.map((pillar, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group relative flex flex-col justify-between rounded-3xl border border-[#cdeae5] bg-white p-8 shadow-md transition-all duration-300 hover:-translate-y-2 hover:border-[#0b6e69]/50 hover:shadow-2xl hover:shadow-[#0b6e69]/15"
                >
                  <div>
                    <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#e6f4f2] text-[#0b6e69] transition-all duration-300 group-hover:bg-[#0b6e69] group-hover:text-white group-hover:scale-110 shadow-sm">
                      <Icon size={28} />
                    </div>

                    <span className="mb-3 inline-block rounded-full bg-[#e6f4f2] border border-[#cdeae5] px-3 py-1 text-xs font-bold text-[#0b6e69]">
                      {pillar.badge}
                    </span>

                    <h3 className="mb-3 text-xl font-bold text-[#133835] group-hover:text-[#0b6e69] transition-colors">
                      {pillar.title}
                    </h3>

                    <p className="text-sm leading-relaxed text-[#496a66]">
                      {pillar.desc}
                    </p>
                  </div>

                  <div className="mt-8 pt-4 border-t border-[#cdeae5]/40 flex items-center gap-2 text-xs font-bold text-[#0b6e69]">
      ...
      <section className="section-padding bg-white border-y border-[#cdeae5]/50">
        <div className="container-custom">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            ...
            <Link
              href={makeLink("/items")}
              className="inline-flex items-center gap-2 rounded-2xl bg-[#e6f4f2] border border-[#cdeae5] px-6 py-3.5 text-sm font-bold text-[#0b6e69] shadow-sm transition-all hover:bg-[#0b6e69] hover:text-white hover:border-[#0b6e69] shrink-0"
            >
      ...
      {/* ================= SERVICES MATRIX ================= */}
      <section className="section-padding bg-gradient-to-b from-[#ebf7f5] via-white to-[#f6fbfa]">
        <div className="container-custom">
          <SectionTitle
      ...
      <section className="section-padding bg-[#072f2c] text-white relative overflow-hidden">
        <div className="pointer-events-none absolute -right-20 -bottom-20 h-96 w-96 rounded-full bg-[#0b6e69]/20 blur-3xl" />
        <div className="container-custom relative z-10">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7">
              <span className="inline-flex items-center gap-2 rounded-full bg-[#0b6e69]/30 border border-[#0b6e69]/50 px-4 py-1.5 text-xs font-bold text-[#a5d8d0] uppercase tracking-wider">
              ...
              <p className="mt-4 text-base sm:text-lg text-[#cdeae5]/90 leading-relaxed">
              ...
              <div className="mt-8 grid sm:grid-cols-2 gap-4">
                <div className="rounded-2xl border border-[#cdeae5]/20 bg-white/5 p-5 backdrop-blur-sm">
                  <h4 className="text-lg font-bold text-white flex items-center gap-2">
                    <ShieldCheck size={20} className="text-[#14b8a6]" />
                    ISO 13485 & CE Compliance
                  </h4>
                  <p className="mt-2 text-xs text-[#cdeae5]/80">
            ...
            <div className="lg:col-span-5">
              <div className="rounded-3xl border border-[#cdeae5]/30 bg-gradient-to-br from-white/10 to-white/5 p-8 backdrop-blur-md text-center">
                <div className="mx-auto flex h-24 w-24 sm:h-28 sm:w-28 flex-col items-center justify-center rounded-full bg-gradient-to-br from-[#0e938b] via-[#0b6e69] to-[#074e49] text-white shadow-2xl shadow-[#0b6e69]/50 border-2 border-teal-300/40 p-2">
                  <span className="text-3xl sm:text-4xl font-black text-white tracking-tight leading-none">
                    100%
                  </span>
                  <span className="text-[10px] sm:text-[11px] font-bold uppercase tracking-wider text-[#e6f4f2] mt-1">
                    Certified
                  </span>
                </div>
                ...
                <p className="mt-3 text-sm text-[#cdeae5] leading-relaxed">
                  All instruments tested with traceable reference standards before dispatch to your medical facility.
                </p>
                <Link
                  href={makeLink("/contact")}
                  className="mt-6 inline-flex items-center justify-center gap-2 rounded-2xl bg-[#0b6e69] !text-white px-8 py-3.5 text-sm font-bold shadow-xl shadow-[#0b6e69]/40 transition-all hover:bg-[#0e938b] hover:shadow-2xl hover:-translate-y-0.5 border border-teal-400/30"
                >
        ...
        <div className="container-custom">
          ...
          <div className="mt-16 grid gap-8 lg:grid-cols-3">
            {testimonials.map((t, idx) => (
              <div
                key={idx}
                className="flex flex-col justify-between rounded-3xl border border-[#cdeae5] bg-white p-8 shadow-md transition-all hover:-translate-y-1 hover:shadow-xl"
              >
                <div>
                  <div className="flex gap-1 text-[#0b6e69] mb-4">
                    {Array.from({ length: t.rating }).map((_, i) => (
                      <span key={i}>★</span>
                    ))}
                  </div>
                  <p className="text-sm sm:text-base leading-relaxed text-[#496a66] italic">
                    &ldquo;{t.quote}&rdquo;
                  </p>
                </div>

                <div className="mt-8 border-t border-[#cdeae5]/60 pt-4 flex items-center gap-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#e6f4f2] text-[#0b6e69] font-bold text-lg">
                    {t.author.charAt(4) || "D"}
                  </div>
                  <div>
                    <h4 className="text-base font-bold text-[#133835]">{t.author}</h4>
                    <p className="text-xs text-[#496a66]">{t.role} — <span className="text-[#0b6e69] font-medium">{t.institution}</span></p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="section-padding bg-gradient-to-br from-[#ebf7f5] via-white to-[#e6f4f2] border-t border-[#cdeae5]">
        <div className="container-custom">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-5">
              <SectionTitle
              ...
              <div className="mt-8 space-y-4">
                {helplinePhone && (
                  <a
                    ...
                    className="flex items-center gap-4 rounded-2xl border border-[#cdeae5] bg-white p-4 shadow-sm hover:border-[#0b6e69]/40 transition-colors"
                  >
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#e6f4f2] text-[#0b6e69] shrink-0">
                      <PhoneCall size={22} />
                    </div>
                    <div>
                      <p className="text-xs font-bold text-[#496a66]">Direct Helpline</p>
                      <p className="text-base font-bold text-[#133835]">{helplinePhone}</p>
                    </div>
                  </a>
                )}
                ...
                {supportEmail && (
                  ...
                  >
                    ...
                    <div>
                      <p className="text-xs font-bold text-[#496a66]">Official Email</p>
                      <p className="text-base font-bold text-[#133835] break-all">{supportEmail}</p>
                    </div>
                  </a>
                )}
              </div>
